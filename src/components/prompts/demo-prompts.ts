...
export const DEMO_PROMPTS: DemoPrompt[] = [
...

  {
    ...
    body: [
      ...
      "",
      "## 実装時の制約",
      "- selector方針: {{selector_policy_text}}",
      "- データ前提: {{test_data_text}}",
      "- 既存E2Eとの重複回避: {{constraints_details}}",
    ].join("\n"),
    pinnedAt: null,
  },

  {
    ...
    body: [
      ...
      "## ロールバック判断メモ",
      "- 影響範囲: {{impact_text}}",
      "- 暫定対応: {{mitigation_text}}",
      "- 判断条件: {{rollback_criteria_text}}",
    ].join("\n"),
    pinnedAt: null,
  },
